...
const index = () => {
  ...
  const addTask = () => {
    ...
    if (check.title || check.deadline) {
      toast.error("Please fill the title or deadline !", {
        position: "top-right",
        autoClose: 2000,
      });
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="w-75 p-4 mx-auto mt-3 shadow">
        ...
        <div className="w-75 p-4 mx-auto shadow">
          <table className="table table-striped table-hover table-bordered">
            <thead>
              <tr>
                <th>ID</th> <th>Title</th> <th>Task deadline</th>{" "}
                <th>Remove</th>
              </tr>
            </thead>
            <tbody>
